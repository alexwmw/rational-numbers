...
namespace RationalNumbers
{
    ...
    {
        /// <summary>
        /// Returns a double-precision floating point number representing this integer number raised to the power of the given rataional number.
        /// </summary>
        ...
        public static double ExpReal(this int baseNumber, RationalNumber r)
            => r.ExpReal(baseNumber);

        /// <summary>
        /// Returns the instance integer to the power of the given power.
        /// </summary>
        internal static int Pow(this int intNumber, double power)
